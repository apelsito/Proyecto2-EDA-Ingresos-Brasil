...
- Comparaciones Temporales:
    ...
    Se visualizaron los ingresos por mes y por categoría económica para cada año, lo que permitió analizar la evolución de los ingresos y detectar tendencias a lo largo del tiempo 📅📈.

- Distribución por Categorías:
    
    Gráficas que desglosan los ingresos por cada categoría económica en todos los años analizados, mostrando cómo fluctuaron los ingresos y qué categorías fueron más significativas 💼.

- Análisis Año a Año:

    Para cada año de 2013 a 2021, se crearon gráficos detallados por mes y categoría, ayudando a identificar picos y caídas significativas en la recaudación mensual 🔍.
...
Este enfoque visual complementa el análisis y facilita la interpretación de los resultados obtenidos en fases anteriores, preparando el terreno para conclusiones y recomendaciones.
